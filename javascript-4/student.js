...
let faveColors = ['black', 'grey', 'blue'];
...
let me = {
    firstname: 'Jordan',
    superHeroName: 'The Myth',
    homeTown: 'Darwin, Australia',
    superPowers: ['Flying', 'Time Travel', 'Mind Control'],
    superPowerXP: function(){
        return Math.floor(Math.random() * 100 + 1)
    },
    profileImage: function(){
        return url = `https://randomuser.me/api/portraits/med/lego/${Math.floor(Math.random() * 10) + 1 }.jpg`
    }
}
...
function setColor(arr){
 let smallArray = arr.splice(0, 3)
 for(i = 0; i < smallArray.length; i++){
     if(smallArray[i] === 'blue'){
         smallArray[i] = '#4D4DFF'
     }
 }
 background(smallArray)
}
...
// Now, imagine your super hero needs to go undercover, and you need to remove all info about them. That is what this function will do. In your function, 
// loop over the obj parameter passed in, and change each keys value to 'redacted'. Outside of the loop but still in the redactInfo function, run the function redacted() 
